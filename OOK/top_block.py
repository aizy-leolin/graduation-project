...
# Title: Top Block
# Generated: Sun Mar 18 22:14:30 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.PHY_recv_bit_0 = PHY.recv_bit(800)
        self.PHY_conv_decode_0 = PHY.conv_decode(100)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.PHY_conv_decode_0, 0), (self.blocks_null_sink_0_0, 0))    
        self.connect((self.PHY_recv_bit_0, 0), (self.PHY_conv_decode_0, 0))    
        self.connect((self.PHY_recv_bit_0, 1), (self.PHY_conv_decode_0, 1))    
        self.connect((self.PHY_recv_bit_0, 2), (self.PHY_conv_decode_0, 2))    
        self.connect((self.blocks_complex_to_float_0, 0), (self.PHY_recv_bit_0, 0))    
