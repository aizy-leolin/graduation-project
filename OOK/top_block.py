...
# Title: Top Block
# Generated: Thu Mar 22 20:19:58 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.PHY_wave_to_bit_0 = PHY.wave_to_bit(decim)
        ...
        self.connect((self.PHY_wave_to_bit_0, 0), (self.PHY_find_preamble_0, 0))    
        self.connect((self.PHY_wave_to_bit_0, 0), (self.blocks_char_to_float_0, 0))    
        self.connect((self.PHY_wave_to_bit_0, 0), (self.blocks_file_sink_0, 0))    
        self.connect((self.PHY_wave_to_bit_0, 0), (self.digital_header_payload_demux_0, 0))    
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.PHY_wave_to_bit_0, 0))    
        ...
        self.connect((self.digital_header_payload_demux_0, 1), (self.digital_crc32_bb_0, 0))    
