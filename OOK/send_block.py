...
# Title: Send Block
# Generated: Fri Jan  5 12:00:34 2018
##################################################
...
class send_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0.set_gain(1000, 0)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1,1,0), True, 1, [])
...
def main(top_block_cls=send_block, options=None):
