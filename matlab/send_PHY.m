% CRC table
table=hex2dec(['00000000';'04C11DB7';'09823B6E';'0D4326D9';...
...
% set your sample here
sample = [1,0,0,1,1,1,0,1];
%pack bit to byte
if mod(length(sample),8)>0
    sample = [sample zeros(1,8-mod(length(sample),8))];
end
data = reshape(sample,8,length(sample)/8)';
data = bin2dec(char(data+48));
